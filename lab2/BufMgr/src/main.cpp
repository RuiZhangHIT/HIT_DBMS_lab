...
void test3()
{
	//reading a non-existent page. Should generate an error
	try
	{
...
void test4()
{
	//unpinning an unpinned page. Should generate an error
...
void test5()
{
	//allocating page when pages in the buffer pool are all pinned. Should generate an error 
	for (i = 0; i < num; i++) {
